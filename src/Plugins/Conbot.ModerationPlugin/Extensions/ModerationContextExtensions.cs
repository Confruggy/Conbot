...
{
    public static async Task<ModerationGuildConfiguration?> GetGuildConfigurationAsync(this ModerationContext context,
        ulong guildId) => await context.GuildConfigurations.AsQueryable().FirstOrDefaultAsync(x => x.GuildId == guildId);
    ...
    public static async Task<PreconfiguredMutedRole?> GetPreconfiguredMutedRoleAsync(this ModerationContext context,
        ulong roleId)
        => await context.PreconfiguredMutedRoles.AsNoTracking().FirstOrDefaultAsync(x => x.RoleId == roleId);
