...
public class RankingModule : ConbotGuildModuleBase
{
        ...
        IMember? member = null)
    {
        ...
        {
            return Reply(member.Id == Context.Author.Id
                ? "You don't have a rank on this server yet."
                : "This member has no rank on this server.");
        }
    ...
    public class Announcements : ConbotModuleBase
    {
        ...
        public Announcements(RankingContext context) => _db = context;
        ...
        public async Task<DiscordCommandResult> ToggleAsync(
            [Description("Whether to enable or disable level up announcements.")]
            ...
            string toggle)
        {
            ...
            switch (toggle)
            {
                ...
                case "disable":
                    ...
                    {
                        return Fail(
                            "You already don't receive notifications when you get mentioned in level up " +
                            "announcements.");
                    }
    ...
    public class RoleRewardsCommands : ConbotGuildModuleBase
    {
        ...
        public async Task<DiscordCommandResult> RemoveAsync(
            [Description("The role of the reward to remove."), Remainder]
            IRole role)
        {
    ...
    public class IgnoredChannelsCommands : ConbotGuildModuleBase
    {
        ...
        public async Task<DiscordCommandResult> AddAsync(
            [Description("The text channel to ignore.")]
        ...
        [OverrideArgumentParser(typeof(InteractiveArgumentParser))]
        public async Task<DiscordCommandResult> RemoveAsync(
            [Description("The text channel to remove from being ignored.")]
            ITextChannel channel)
        {
            var ignoredChannel = await _db.GetIgnoredChannelAsync(channel);
