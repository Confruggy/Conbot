...
namespace Conbot.HelpPlugin
{
    ...
    {
        private readonly IEnumerable<Command> _overloads;
        ...
        public ValueTask OnOverloadSelectionAsync(SelectionEventArgs e)
        {
            ...
            if (ParentView is not null)
                Menu.View = new CommandView(overload, ParentView, StartView, TemplateMessage);
            else
                Menu.View = new CommandView(overload, Context, Configuration, TemplateMessage);
