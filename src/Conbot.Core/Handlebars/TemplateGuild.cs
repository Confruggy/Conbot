...
namespace Conbot
{
    public class TemplateGuild
    {
        ...
        public TemplateGuild(IGuild guild)
        {
            ...
            _publicUpdatesChannelId = new(() =>
            {
                if (PublicUpdatesChannelId is not null)
                {
            ...
            _systemChannelId = new(() =>
            {
                if (SystemChannelId is not null)
                {
            ...
            _widgetChannelId = new(() =>
            {
                if (WidgetChannelId is not null)
                {
